...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between py-4">
            <p class="page-title">Fabric Type</p>
            <a class="btn btn-sm btn-success" href="{{route('fabric-type.create')}}">Add New</a>
        </div>
